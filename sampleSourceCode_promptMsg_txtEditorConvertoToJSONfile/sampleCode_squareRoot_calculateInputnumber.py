...
root = tk.Tk()
root.title("SquareRoot Calculation support by AnitaCoffeeShop")
...
button1 = tk.Button(text="Get the Square Root", command = getSquareRoot, background='pink', font=('helvetica', 9, 'bold'))
